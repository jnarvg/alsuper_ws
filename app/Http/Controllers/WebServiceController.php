...
class PolizaWSController extends Controller
{
    public function consultarRECNOPolizas(){
      ...
      $sourceXML = file_get_contents('http://ws.alsuper.com:8095/ValorMaximoPF.asmx/getMax?n_tbl=ZC1000', true );
      ...
      */
      ...
      $xml =  XmlParser::extract($contenido);
    ...
    public function crearRegistroPoliza($data, $tipo_poliza)
    {
        ...
        $result = file_get_contents($url_poliza, true, $context);
    ...
    public function ws_poliza(request $request)
    {
      ...
      if ($request->get('empresa_id') == null) {
        ...
        ->select('FFRMS_9760C657 as tipo_poliza','FFRMS_E80A068F as empresa_id','FFRMS_E815C248 as fecha_inicio','FFRMS_714B219A as fecha_fin','FFRMS_4CDA52E8 as consecutivo')
        ->where('FFRMS_C10D87B8','On')
        ->first();
        if ($menuPoliza) {
      ...
      if ( $tipo_poliza != null and $empresa_id != null and $fecha_inicio != null and $fecha_fin != null and $fecha_inicio != '' and $fecha_fin != '') {
        ...
        if ($tipo_poliza == 4763) {
          ...
          $polizasinsertadas = $this->enviarFactura( $fecha_inicio, $fecha_fin, $empresa_id, $doc_num );
        ...
        elseif ($tipo_poliza == 4808) {
          $reccnoanterior = $this->consultarRECNOPolizas() - 1;
          $polizasinsertadas = $this->enviarNotaCredito( $fecha_inicio, $fecha_fin, $empresa_id, $doc_num );
          $reccnoultimo = $this->consultarRECNOPolizas() - 1;
          $nuevoConsecutivo = $doc_num +1;
          $consecutivo_poliza = DB::table('SI_FORMS_BAPP02F92DB8_FRM_B6B5F9F7')->update(['FFRMS_4CDA52E8' => $nuevoConsecutivo ]);
        }
        elseif ($tipo_poliza == 4831) {
          $reccnoanterior = $this->consultarRECNOPolizas() - 1;
          $polizasinsertadas = $this->enviarPagos( $fecha_inicio, $fecha_fin, $empresa_id, $Dep_garantía_cobrar_cliente, $Dep_garantía_clientes, $Dep_garantía_nombre, $doc_num );
          $reccnoultimo = $this->consultarRECNOPolizas() - 1;
          $nuevoConsecutivo = $doc_num +1;
          $consecutivo_poliza = DB::table('SI_FORMS_BAPP02F92DB8_FRM_B6B5F9F7')->update(['FFRMS_4CDA52E8' => $nuevoConsecutivo ]);
        }
        elseif ($tipo_poliza == 4975) {
          $reccnoanterior = $this->consultarRECNOPolizas() - 1;
          $polizasinsertadas = $this->enviarExcedentesAplicados( $fecha_inicio, $fecha_fin, $empresa_id, $Dep_garantía_cobrar_cliente, $Dep_garantía_clientes, $Dep_garantía_nombre,  $otros_pasivos_cuenta, $doc_num );
          $reccnoultimo = $this->consultarRECNOPolizas() - 1;
          $nuevoConsecutivo = $doc_num +1;
          $consecutivo_poliza = DB::table('SI_FORMS_BAPP02F92DB8_FRM_B6B5F9F7')->update(['FFRMS_4CDA52E8' => $nuevoConsecutivo ]);
        }
        elseif ($tipo_poliza == 4976) {
          $reccnoanterior = $this->consultarRECNOPolizas() - 1;
          $polizasinsertadas = $this->enviarExcedentesSinAplicar( $fecha_inicio, $fecha_fin, $empresa_id,$otros_pasivos_cuenta, $doc_num );
          $reccnoultimo = $this->consultarRECNOPolizas() - 1;
          $nuevoConsecutivo = $doc_num +1;
          $consecutivo_poliza = DB::table('SI_FORMS_BAPP02F92DB8_FRM_B6B5F9F7')->update(['FFRMS_4CDA52E8' => $nuevoConsecutivo ]);
        }
        elseif ($tipo_poliza == 4977) {
          $reccnoanterior = $this->consultarRECNOPolizas() - 1;
          $polizasinsertadas = $this->enviarDepositosGarantia( $fecha_inicio, $fecha_fin, $empresa_id, $Dep_garantía_clientes, $Dep_garantía_cobrar_cliente, $doc_num );
          $reccnoultimo = $this->consultarRECNOPolizas() - 1;
          $nuevoConsecutivo = $doc_num +1;
          $consecutivo_poliza = DB::table('SI_FORMS_BAPP02F92DB8_FRM_B6B5F9F7')->update(['FFRMS_4CDA52E8' => $nuevoConsecutivo ]);
        }
        elseif ($tipo_poliza == 5051) {
          $reccnoanterior = $this->consultarRECNOPolizas() - 1;
          $polizasinsertadas =  $this->enviarJuridicos( $fecha_inicio, $fecha_fin, $empresa_id, $cuenta_deudores_diversos, $doc_num );
          $reccnoultimo = $this->consultarRECNOPolizas() - 1;
          $nuevoConsecutivo = $doc_num +1;
          $consecutivo_poliza = DB::table('SI_FORMS_BAPP02F92DB8_FRM_B6B5F9F7')->update(['FFRMS_4CDA52E8' => $nuevoConsecutivo ]);
        }
        elseif ($tipo_poliza == 5052) {
          $reccnoanterior = $this->consultarRECNOPolizas() - 1;
          $polizasinsertadas = $this->enviarPagosJuridicos( $fecha_inicio, $fecha_fin, $empresa_id, $cuenta_deudores_diversos ,$doc_num );
          $reccnoultimo = $this->consultarRECNOPolizas() - 1;
          $nuevoConsecutivo = $doc_num +1;
          $consecutivo_poliza = DB::table('SI_FORMS_BAPP02F92DB8_FRM_B6B5F9F7')->update(['FFRMS_4CDA52E8' => $nuevoConsecutivo ]);
        }
        elseif ($tipo_poliza == 4809) {
          $reccnoanterior = $this->consultarRECNOPolizas() - 1;
          $polizasinsertadas = $this->enviarBancos( $fecha_inicio, $fecha_fin, $empresa_id, $doc_num );
          $reccnoultimo = $this->consultarRECNOPolizas() - 1;
        ...
        elseif ($tipo_poliza == 5020) {
          $reccnoanterior = $this->consultarRECNOPolizas() - 1;
          $polizasinsertadas = $this->enviarBancosExcedentes( $fecha_inicio, $fecha_fin, $empresa_id, $doc_num );
          $reccnoultimo = $this->consultarRECNOPolizas() - 1;
          $nuevoConsecutivoBancos = $doc_num +1;
          $consecutivo_poliza = DB::table('SI_FORMS_BAPP02F92DB8_FRM_B6B5F9F7')->update(['FFRMS_FFD26E6B' => $nuevoConsecutivoBancos ]);
        }
      ...
      return view('webservices.polizas.index', compact('request','tipos_polizas','empresas','reccnoanterior','polizasinsertadas', 'reccnoultimo'));

    }

    ///////////////// FUNCIONES POR SEPARADO
    public function enviarFactura($fecha_inicio, $fecha_fin, $empresa_id, $doc_num )
    {
    ...
    public function enviarNotaCredito($fecha_inicio, $fecha_fin, $empresa_id , $doc_num )
    {
      $FechaActual = date('Ymd');
      $a = 1;
      $c = 1;
    ...
    public function enviarPagos($fecha_inicio, $fecha_fin, $empresa_id, $Dep_garantía_cobrar_cliente, $Dep_garantía_clientes, $Dep_garantía_nombre, $doc_num )
    {
      $FechaActual = date('Ymd');
      $a = 0;
      $c = 1;
      ...
      ->get();
      foreach ($selectPagos as $k) {
        $id_Factura = $k->FFRMS_AE0C9BD0;
            ...
            if($folioAnterior != $FolioPadre){
              ...
              foreach ($SelectFacturas as $filaFactura) {
                ...
                foreach ($selectPagos as $filaPagos) {
                  ...
                  $filaUnidad = DB::table('SI_FORMS_BAPP02F92DB8_FRM_E2241755')->where('id_FRM_E2241755', $UnidadF)->first();
                  if ($filaUnidad) {
                    $ItemContable = $filaUnidad->FFRMS_649B0EF1;
                    $NumeroEmpresa = $filaUnidad->FFRMS_79965C05;
                    $NombreEmpresa = $filaUnidad->FFRMS_DB97FE86;
                    $CentroCosto = $filaUnidad->FFRMS_85D52E6B;
                  }
    ...
    public function enviarExcedentesAplicados($fecha_inicio, $fecha_fin, $empresa_id, $Dep_garantía_cobrar_cliente, $Dep_garantía_clientes, $Dep_garantía_nombre,  $otros_pasivos_cuenta , $doc_num )
    {
      $FechaActual = date('Ymd');
      $a = 0;
      $c = 1;
              ...
              foreach ($SelectArrendatario as $filaArrendatario) {
                ...
                foreach ($excedentes as $filaExcedente) {
                  ...
                  if ($Factura_tipo == 'Deposito en garantia') {
                    ...
                    $p12_HIST_concatenado = 'CTE '.$Ncliente.' '.$Arrendatario;
                  }else{
                    $p12_HIST_concatenado = 'F-'.$folio_timbre.' CTE '.$Ncliente.' '.$Arrendatario;
                  }
                  ...
                  if ($Factura_tipo == 'Deposito en garantia') {
                    $p12_HIST_concatenado = 'CTO '.$folioCto.' CTE '.$Ncliente.' '.$Arrendatario;
                    ///// SEGUNDO ASIENTO 2/4 DEPOSITO GARANTIA
                    $p31_RECNO_max = $this->consultarRECNOPolizas();
                    if ($p31_RECNO_max != null) {
                      $p5_DC_debitoOrCredito = '1';
    ...
    public function enviarExcedentesSinAplicar($fecha_inicio, $fecha_fin, $empresa_id, $otros_pasivos_cuenta, $doc_num )
    {
      $FechaActual = date('Ymd');
      $a = 0;
      $c = 1;
            ...
            if($folioAnterior != $FolioPadre){
              ...
              foreach ($SelectArrendatario as $filaArrendatario) {
                ...
                foreach ($excedentes as $filaExcedente) {
                  ...
                  $SelectSucursal = DB::table('SI_FORMS_BAPP02F92DB8_FRM_54CDED61')
                  ->where('id_FRM_54CDED61', $sucursal_predefinida_id)->first();
                  if ($SelectSucursal) {
                  ...
                  $p12_HIST_concatenado = 'EMP '.$NEmpresa.' CTE '.$Ncliente.' '.$Arrendatario;
                  if($tipoComprobante == 1){
                    $p17_LOTE_tipo_comprobante = 3;//tipo de poliza Ingresos
                  }
                  elseif($tipoComprobante == 2){
    ...
    public function enviarDepositosGarantia($fecha_inicio, $fecha_fin, $empresa_id, $Dep_garantía_clientes, $Dep_garantía_cobrar_cliente, $doc_num )
    {
      $FechaActual = date('Ymd');
      $a = 0;
      $c = 1;
      ...
      foreach ($selectDepositosGarantia as $filaFactura) {
        if($a <= 999){
          ...
          $p12_HIST_concatenado = 'L-'.$codigo_unidad.' CTE-'.$Ncliente." ".$Arrendatario;
          $p27_EMPORI = $NumeroEmpresa;
    ...
    public function enviarJuridicos($fecha_inicio, $fecha_fin, $empresa_id, $cuenta_deudores_diversos, $doc_num )
    {
      $FechaActual = date('Ymd');
      $a = 1;
      $c = 1;
    ...
    public function enviarPagosJuridicos($fecha_inicio, $fecha_fin, $empresa_id, $cuenta_deudores_diversos, $doc_num )
    {
      $FechaActual = date('Ymd');
      $a = 0;
      $c = 1;
    ...
    public function enviarBancos($fecha_inicio, $fecha_fin, $empresa_id, $doc_num )
    {
        ...
        foreach ($SelectPagos as $filaPagos) {
          ...
          if ($p97_RECNO_max != null) {
            ...
            'p2_DATA' => $FechaMovimiento,/*E*/
            'p5_VALOR' => $MontoP, /*Q*/
            'p7_BANCO' => $NumeroBanco,/*F*/
            'p8_AGENCI' => $NumeroAgencia,/*G*/
            'p9_CONTA' => $NumeroCuenta,/*H*/
            'p11_DOCUME' => substr($ContadorB, 0, 50),/*S*/
            'p12_VENCTO' => $FechaMovimiento,/*AB*/
            ...
            'p26_DTDIGI' => $FechaMovimiento,/*AM*/
            'p34_DTDISP' => $FechaMovimiento,/*AT*/
    ...
    public function enviarBancosExcedentes($fecha_inicio, $fecha_fin, $empresa_id, $doc_num )
    {
        ////VARIABLES DATA FINANCIERO
        $a = 0;
        $c = 1;
