...
<div class="content mt-3">
  <div class="card">
    <div class="card-body">
      {{ Form::open(array('action'=>array('WebServiceController@ws_inventarios'),'method'=>'get')) }}
        <div class="row">
          <div class="col-md-3">
            <div class="form-group">
              <label for="fecha">Fecha</label>
              <input type="date" name="fecha" id="fecha" value="1970-01-01" class="form-control">
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
