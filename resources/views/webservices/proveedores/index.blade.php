...
<div class="content mt-3">
  <div class="card">
    <div class="card-body">
      {{ Form::open(array('action'=>array('WebServiceController@ws_proveedores'),'method'=>'get')) }}
        <div class="row">
          <div class="col-md-3">
            <div class="form-group">
              <label for="numero_proveedor">Numero proveedor</label>
              <input type="text" name="numero_proveedor" id="numero_proveedor" value="0" class="form-control">
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
